...
type AssignmentSolidProps = Omit<React.ComponentProps<typeof Icon>, 'children'>;

function AssignmentSolid({ size, ...restProps }: AssignmentSolidProps) {
  return (
...
export default AssignmentSolid;

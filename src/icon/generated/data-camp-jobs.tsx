...
type DataCampJobsProps = Omit<React.ComponentProps<typeof Icon>, 'children'>;

function DataCampJobs({ size, ...restProps }: DataCampJobsProps) {
  return (

...
type ExerciseSolidProps = Omit<React.ComponentProps<typeof Icon>, 'children'>;

function ExerciseSolid({ size, ...restProps }: ExerciseSolidProps) {
  return (

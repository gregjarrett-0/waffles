...
They should **never** be interactive and instead a [Button](/components/button) or the future `Tag` component used if interaction is desired.

## Best practices

Content should **not** contain icons or anything besides text.

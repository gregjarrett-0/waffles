...
import UseTitleCaseBasicUsage from '../../examples/hooks/use-title-case-basic-usage';
...
Converts the provided string to match the required title case. Waffles [Button](/components/button) and [Heading](/components/heading) automatically use this for string content.

<Example title="Basic Usage" path="hooks/use-title-case-basic-usage">
  <UseTitleCaseBasicUsage />
</Example>

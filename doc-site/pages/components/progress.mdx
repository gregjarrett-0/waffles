...
This `mode` should be used when a process consists of multiple complex tasks, with distinct milestones. It is **not** recommended to use this mode with fewer than two (2) steps, or greater than seven (7)&mdash;consider restructuring the flow of the task instead.

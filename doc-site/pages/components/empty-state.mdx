...
An Empty State should replace the content that would show under normal circumstances and should be clear in telling users what it's for / why they're seeing it.
...
A list can be used within the Empty State component to give a brief overview of options available if there was content shown. This can include reasoning to entice a user in to following the proceeding action.

import { Star, Heart, Chat, Database, Rocket } from '@datacamp/waffles/icon';

import Layout from '../../components/content-layout';
import DesignPrinciples from '../../components/design-principles';

<Layout title="Design Principles" description="Create a frictionless data journey to reward, inspire and delight our customers.">

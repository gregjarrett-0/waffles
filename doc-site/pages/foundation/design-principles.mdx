...
<DesignPrinciples>
  ...
  <DesignPrinciples.Card title="Make smart decisions using data and insights" icon={<Database size="xlarge" />}>

    - Know when using data makes sense and when it doesn’t
    - Access the value vs risk trade off with a bias to action
    - Speaking to even one customer or colleague will add value 
  ...
  <DesignPrinciples.Card title="Remove friction with seamless experiences" icon={<Rocket size="xlarge" />}>
    ...
    - Build consistency between different products whenever possible

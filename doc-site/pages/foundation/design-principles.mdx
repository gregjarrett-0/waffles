...
<Layout title="Design Principles" description="The vision of how to create and enhance DataCamp digital products, which our users enjoy when improving their data skills.">

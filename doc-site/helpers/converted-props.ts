...
// Find and extract proper props definitions from auto generated structure
...
function filteredRawProps(
  ...
  return propsMetadata.reduce<PropRawMetadata[]>((rawProps, metadata) => {
    ...
    // Since 'never' props are part of complex discriminating unions, they are required only in some cases
...
// Convert auto generated props to the format digestible by final component
